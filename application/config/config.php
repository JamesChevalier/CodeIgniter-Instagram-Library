...
/*
| CodeIgniter Instagram Library Configuration
*/

// Enter the Client ID provided by Instagram as the value
$config['instagram_client_id']		= '';

// Enter the Client Secret provided by Instagram as the value
